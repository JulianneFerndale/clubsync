<nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex items-center justify-around h-16 z-20">
    ...
    <a href="{{ route('officer.activities.index') }}"
       class="flex flex-col items-center gap-0.5 flex-1 py-2 {{ request()->routeIs('officer.activities*') ? 'text-[#1B5E20]' : 'text-gray-400' }}">
        <svg class="w-6 h-6" fill="{{ request()->routeIs('officer.activities*') ? '#1B5E20' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <span class="text-[10px] font-medium {{ request()->routeIs('officer.activities*') ? 'border-b-2 border-[#F9A825]' : '' }}">Calendar</span>
    </a>
    ...
    <a href="{{ route('clubs.members.index') }}"
       class="flex flex-col items-center gap-0.5 flex-1 py-2 {{ request()->routeIs('clubs.members*') ? 'text-[#1B5E20]' : 'text-gray-400' }}">
        <svg class="w-6 h-6" fill="{{ request()->routeIs('clubs.members*') ? '#1B5E20' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <span class="text-[10px] font-medium {{ request()->routeIs('clubs.members*') ? 'border-b-2 border-[#F9A825]' : '' }}">Members</span>
    </a>
</nav>
